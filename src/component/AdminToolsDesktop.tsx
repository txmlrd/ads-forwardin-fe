...
function AdminToolsDesktop() {
  ...
  return (
    <div className="relative hidden md:flex w-[318px] h-[200px] md:w-[1000px] md:h-[400px]" onClick={handleImageClick}>
      {isFirstImageOnTop ? (
        <>
          <img
...
export default AdminToolsDesktop;
